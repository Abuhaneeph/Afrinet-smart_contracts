...
import "../src/CrossChainMessageSender.sol";
import "../src/CrossChainMessageReceiver.sol";
...
contract CrossChainMessagingTest is Test {
    ...
    function testSendMessage() public {
        uint16 targetChain = 35; // Mantle Testnet Wormhole chain ID
        address targetAddress = address(receiverContract); // Use the receiver contract's address
        string memory message = "Hello from Avalanche to Mantle!";
